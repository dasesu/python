...
No podemos poner modulos dentro de modulos, recordemos que los modulos son simplemente archivos yno hay un modo de colocar un archivo dentro de otro archivo.
...
2) Crear un arcivo dentro dle directorio que generalmente sera vacio con el nombre `__init__.py`
