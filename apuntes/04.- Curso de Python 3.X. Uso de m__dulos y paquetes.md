...
Los archivos si pueden ir dentro de directorios, estos directorios son es lo que vendrian siendo paquetes en python. Los paquetes son una coleccion de modulos que se encuentran en un mismo directorio.
